...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-md border-gray-700 dark:border-white border bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Subscribe for more updates from us
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        We promise not to terribly spam your inbox.
      </p>
      <div>
        <input
          type="text"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium bg-black text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark"
        />
